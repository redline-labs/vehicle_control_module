...
#define CONF_QSPI_BAUD 50000000
#endif
...
#define CONF_QSPI_BAUD_RATE ((CONF_QSPI_FREQUENCY / CONF_QSPI_BAUD) - 1)
#if CONF_QSPI_BAUD > CONF_QSPI_FREQUENCY || CONF_QSPI_BAUD_RATE > 255
...
#define CONF_QSPI_DLYCS (((CONF_QSPI_FREQUENCY / 1000000) * CONF_QSPI_DLY_CS) / 1000)
#endif

/* Calculates the value of the CSR DLYBS field given the desired delay (in ns) */
#ifndef CONF_QSPI_DLYBS
#define CONF_QSPI_DLYBS (((CONF_QSPI_FREQUENCY / 1000000) * CONF_QSPI_DLY_BS) / 1000)
#endif
